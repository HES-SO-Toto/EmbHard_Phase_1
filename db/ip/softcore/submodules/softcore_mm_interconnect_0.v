...
module softcore_mm_interconnect_0 (
	...
	wire  [102:0] gpio_avalon_slave_0_agent_rf_source_data;                                  // GPIO_avalon_slave_0_agent:rf_source_data -> GPIO_avalon_slave_0_agent_rsp_fifo:in_data
	...
	wire  [102:0] gpio_avalon_slave_0_agent_rsp_fifo_out_data;                               // GPIO_avalon_slave_0_agent_rsp_fifo:out_data -> GPIO_avalon_slave_0_agent:rf_sink_data
	...
	wire  [101:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> GPIO_avalon_slave_0_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                     // GPIO_avalon_slave_0_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [6:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> GPIO_avalon_slave_0_agent:cp_channel
	...
	wire  [101:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> CPU_debug_mem_slave_agent:cp_data
	...
	wire  [101:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> altpll_0_pll_slave_agent:cp_data
	...
	wire  [101:0] gpio_avalon_slave_0_agent_rp_data;                                         // GPIO_avalon_slave_0_agent:rp_data -> router_003:sink_data
	...
	wire  [101:0] cpu_debug_mem_slave_agent_rp_data;                                         // CPU_debug_mem_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [101:0] altpll_0_pll_slave_agent_rp_data;                                          // altpll_0_pll_slave_agent:rp_data -> router_006:sink_data
	...
	wire  [101:0] rsp_demux_004_src0_data;                                                   // rsp_demux_004:src0_data -> crosser_001:in_data
	...
	wire  [101:0] crosser_001_out_data;                                                      // crosser_001:out_data -> rsp_mux:sink4_data
	...
	softcore_mm_interconnect_0_router_002 router_004 (
	...
	softcore_mm_interconnect_0_cmd_mux_003 cmd_mux_003 (
		.clk                 (altpll_0_c0_clk),                       //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	softcore_mm_interconnect_0_cmd_mux_003 cmd_mux_005 (
		.clk                 (altpll_0_c0_clk),                       //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	softcore_mm_interconnect_0_rsp_demux_003 rsp_demux_003 (
		.clk                (altpll_0_c0_clk),                       //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	softcore_mm_interconnect_0_rsp_demux_003 rsp_demux_005 (
		.clk                (altpll_0_c0_clk),                                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset),                   // clk_reset.reset
